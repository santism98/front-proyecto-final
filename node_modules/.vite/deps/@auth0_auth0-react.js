...
// .yarn/__virtual__/@auth0-auth0-react-virtual-e7b2f716cb/0/cache/@auth0-auth0-react-npm-2.1.0-57029e64b4-f1e480d7ab.zip/node_modules/@auth0/auth0-react/dist/auth0-react.esm.js
...
var r = { name: "auth0-spa-js", version: "2.0.4" };
var c = () => Date.now();
...
var Z = class {
  constructor(e2, t2) {
    this.storage = e2, this.clientId = t2, this.storageKey = `a0.spajs.txs.${this.clientId}`, this.transaction = this.storage.get(this.storageKey);
  }
  create(e2) {
    this.transaction = e2, this.storage.save(this.storageKey, e2, { daysUntilExpire: 1 });
  }
  get() {
...
var V = { get(e2) {
  const t2 = R.get(e2);
  return t2 || R.get(`_legacy_${e2}`);
}, save(e2, t2, i2) {
  let o2 = {};
  "https:" === window.location.protocol && (o2 = { secure: true }), (null == i2 ? void 0 : i2.daysUntilExpire) && (o2.expires = i2.daysUntilExpire), (null == i2 ? void 0 : i2.cookieDomain) && (o2.domain = i2.cookieDomain), X(`_legacy_${e2}`, JSON.stringify(t2), o2), R.save(e2, t2, i2);
}, remove(e2, t2) {
  let i2 = {};
  (null == t2 ? void 0 : t2.cookieDomain) && (i2.domain = t2.cookieDomain), N(e2, i2), R.remove(e2, t2), R.remove(`_legacy_${e2}`, t2);
} };
var D = { get(e2) {
...
var te = class {
  ...
  async _verifyIdToken(e2, t2, i2) {
    ...
    return E({ iss: this.tokenIssuer, aud: this.options.clientId, id_token: e2, nonce: t2, organizationId: i2, leeway: this.options.leeway, max_age: (n2 = this.options.authorizationParams.max_age, "string" != typeof n2 ? n2 : parseInt(n2, 10) || void 0), now: o2 });
    var n2;
  }
  ...
  async handleRedirectCallback(e2 = window.location.href) {
    ...
    if (!s2.code_verifier || s2.state && s2.state !== i2)
      throw new Error("Invalid state");
    const r2 = s2.organizationId, c2 = s2.nonce, d2 = s2.redirect_uri;
    return await this._requestToken(Object.assign({ audience: s2.audience, scope: s2.scope, code_verifier: s2.code_verifier, grant_type: "authorization_code", code: o2 }, d2 ? { redirect_uri: d2 } : {}), { nonceIn: c2, organizationId: r2 }), { appState: s2.appState };
  }
