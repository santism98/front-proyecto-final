import {
  MapContainer
} from "./chunk-IRVGOSRL.js";
import {
  TileLayer
} from "./chunk-OXEHB2CC.js";
import {
  useMap,
  useMapEvent,
  useMapEvents
} from "./chunk-7H57O7I6.js";
import {
  LeafletProvider,
  addClassName,
...
function createControlledLayer(addLayerToControl) {
  return function ControlledLayer(props) {
    ...
    return props.children ? import_react.default.createElement(LeafletProvider, {
      value: context
    }, props.children) : null;
  };
}
...
var Marker = createLayerComponent(function createMarker({ position, ...options }, ctx) {
  const marker = new import_leaflet9.Marker(position, options);
  return createElementObject(marker, extendContext(ctx, {
    overlayContainer: marker
  }));
...
function PaneComponent(props, forwardedRef) {
  const [paneName] = (0, import_react2.useState)(props.name);
  const [paneElement, setPaneElement] = (0, import_react2.useState)(null);
  (0, import_react2.useImperativeHandle)(forwardedRef, () => paneElement, [
    paneElement
  ]);
  const context = useLeafletContext();
  const newContext = (0, import_react2.useMemo)(() => ({
    ...context,
    pane: paneName
  }), [
    context
  ...
  return props.children != null && paneElement != null ? (0, import_react_dom.createPortal)(import_react2.default.createElement(LeafletProvider, {
    value: newContext
  }, props.children), paneElement) : null;
}
var Pane = (0, import_react2.forwardRef)(PaneComponent);
...
var Polygon = createPathComponent(function createPolygon({ positions, ...options }, ctx) {
  const polygon = new import_leaflet10.Polygon(positions, options);
...
var Polyline = createPathComponent(function createPolyline({ positions, ...options }, ctx) {
  const polyline = new import_leaflet11.Polyline(positions, options);
...
var Popup = createOverlayComponent(function createPopup(props, context) {
  const popup = new import_leaflet12.Popup(props, context.overlayContainer);
  return createElementObject(popup, context);
}, function usePopupLifecycle(element, context, { position }, setOpen) {
  (0, import_react3.useEffect)(function addPopup() {
...
var Rectangle = createPathComponent(function createRectangle({ bounds, ...options }, ctx) {
  const rectangle = new import_leaflet13.Rectangle(bounds, options);
...
var ScaleControl = createControlComponent(function createScaleControl(props) {
  return new import_leaflet14.Control.Scale(props);
});
...
var useSVGOverlayElement = createElementHook(function createSVGOverlay(props, context) {
  ...
  const overlay = new import_leaflet15.SVGOverlay(container, bounds, options);
...
function SVGOverlayComponent({ children, ...options }, forwardedRef) {
  ...
  (0, import_react4.useImperativeHandle)(forwardedRef, () => instance);
  return container == null || children == null ? null : (0, import_react_dom2.createPortal)(children, container);
}
var SVGOverlay = (0, import_react4.forwardRef)(SVGOverlayComponent);
...
var Tooltip = createOverlayComponent(function createTooltip(props, context) {
  const tooltip = new import_leaflet16.Tooltip(props, context.overlayContainer);
  return createElementObject(tooltip, context);
}, function useTooltipLifecycle(element, context, { position }, setOpen) {
  (0, import_react5.useEffect)(function addTooltip() {
...
var VideoOverlay = createLayerComponent(function createVideoOverlay({ bounds, url, ...options }, ctx) {
  var _a;
  const overlay = new import_leaflet17.VideoOverlay(url, bounds, options);
...
var WMSTileLayer = createTileLayerComponent(function createWMSTileLayer({ eventHandlers: _eh, params = {}, url, ...options }, context) {
  const layer = new import_leaflet18.TileLayer.WMS(url, {
    ...params,
...
var ZoomControl = createControlComponent(function createZoomControl(props) {
  return new import_leaflet19.Control.Zoom(props);
});
export {
  AttributionControl,
  Circle,
